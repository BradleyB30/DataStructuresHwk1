...
int main()
{
  try
  {
    ...
    ///////////////////////// TO-DO (1) //////////////////////////////
      ...
      ///
    GroceryStore foodForThoughtSuperStore;
    /////////////////////// END-TO-DO (1) ////////////////////////////
    ...
    ///////////////////////// TO-DO (2) //////////////////////////////
      ...
      ///
    auto shoppingCarts = foodForThoughtSuperStore.makeShoppingCarts();
    /////////////////////// END-TO-DO (2) ////////////////////////////
    ...
    ///////////////////////// TO-DO (3) //////////////////////////////
      ...
      ///
    auto groceryItemsSold = foodForThoughtSuperStore.ringUpCustomers( shoppingCarts );
    /////////////////////// END-TO-DO (3) ////////////////////////////
    ...
    ///////////////////////// TO-DO (4) //////////////////////////////
      ...
      /// store's inventory.
      ///
    foodForThoughtSuperStore.inventory().erase( "00041331092609" );
    /////////////////////// END-TO-DO (4) ////////////////////////////
    ...
    foodForThoughtSuperStore.reorderItems( groceryItemsSold );
    /////////////////////// END-TO-DO (5) ////////////////////////////
  }
